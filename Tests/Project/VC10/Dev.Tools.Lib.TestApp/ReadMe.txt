========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet Dev.Tools.Lib.TestApp
========================================================================

AppWizard a créé cette application Dev.Tools.Lib.TestApp pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application Dev.Tools.Lib.TestApp.


Dev.Tools.Lib.TestApp.vcxproj
...
Dev.Tools.Lib.TestApp.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé Dev.Tools.Lib.TestApp.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
